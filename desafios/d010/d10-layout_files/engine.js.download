...
if ("false" == "true") console.log(message);
};
...
dwr.engine._pathToDwrServlet = "https://wireframepro.mockflow.com/dwr";
...
dwr.engine._pathToDwrServlet = "https://wireframepro.mockflow.com/dwr";
dwr.engine._overridePath = "https://wireframepro.mockflow.com/dwr";
...
var extraattrcookie = "; Secure; HttpOnly; SameSite=None ";

if(dwr.engine._pathToDwrServlet.includes("localhost"))
extraattrcookie = "; SameSite=Strict ";



document.cookie = "DWRSESSIONID=" + dwrsess + attrs + extraattrcookie;
...
$.ajax({
	  type: "POST",
	  url: batch.path+batch.mode+batch.map['c0-scriptName']+'.'+batch.map['c0-methodName']+'.dwr',
	  data:batch.map, 
